...
} else if (match_routes($request_uri, '/recipes')) {
  require 'pages/recipe_list.php';
} else if (match_routes($request_uri, '/suggestions')) {
  require 'pages/suggestion_form.php';
} else if (match_routes($request_uri, '/sourdough')) {
  require 'pages/sourdough.php';
} else if (match_routes($request_uri, '/focaccia')) {
  require 'pages/focaccia.php';
} else {
